...
export default function JobApplicants({ params }: JobApplicantsProps) {
  ...
  useEffect(() => {
    const checkAuth = async () => {
      ...
      // Verify user is a recruiter (implement your own logic)
      ...
      try {
        ...
        if (jobDoc.exists()) {
          ...
          applicationsSnapshot.forEach((doc) => {
            ...
            // Generate a random match score between 60 and 99 for demo
