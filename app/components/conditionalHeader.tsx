...
export default function ConditionalHeader() {
  ...
  // Pages where we don't want to show the header - updated to include browse jobs
  const noHeaderPaths = ['/browse-jobs'];
  
  // Changed logic to show header on all pages except those in noHeaderPaths
  ...
  // Don't render anything if we're on a no-header path
  if (!shouldShowHeader) {
    return null;
  }
